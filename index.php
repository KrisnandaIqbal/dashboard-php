...
?>
    ...
    <head>
        ...
        <title>NAMELESS | monitoring</title>
        <!-- BOOTSTRAP STYLES-->
            ...
            <nav class="navbar-default navbar-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a href="?page=anggota"><i class="fa fa-laptop fa-2x"></i> Data Mahasiswa</a>

                        <li>
                            <a href="?page=absen"><i class="fa fa-edit fa-2x"></i></i> Absensi</a>
                        </li>
                        <li>
                            <a href="?page=laporan"><i class="fa fa-calendar fa-2x"></i></i> Laporan</a>
                        </li>
                        ...
                        <div class="col-md-12">
                            ...
                            if ($page == "absen") {
                                if ($aksi == "") {
                                    ...
                                    include "page/absen/form_laporan_buku.php";
                                }
                            } elseif ($page == "lokasi") {
                                if ($aksi == "") {
